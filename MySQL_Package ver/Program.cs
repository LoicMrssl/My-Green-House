...
public class DBConnect
{
    ...
    public void CloseConnection()
    {
        ...
        {
            connection.Close();
            PackageHost.WriteInfo("My SQL server disconnected");
            this.status = "disconnected";
        }
        catch (MySqlException ex)
        {
    ...
    public void Insert(string table, string values)
    {
        ...
        try
        {
            if (this.status == "connected")
            {
                ...
                //Execute command
                cmd.ExecuteNonQuery();
                PackageHost.WriteInfo("Successfuly add querry ", query);
    ...
    public string[][] Select(string table, string selection)
    {
        ...
        try
        {
            ...
            {
                PackageHost.WriteError("Connexion Error");
                return tabfinal;
            }
        }
        catch (MySqlException ex)
...
namespace MySQL
{
    ...
    public class Program : PackageBase
    {
        ...
        [MessageCallback]
        public void Insert_BD(string table_arg, string values)
        {
            database.Insert(table_arg, values);
        }
        /// <summary>
        ...
        [MessageCallback]
        public void Update_BD(string table_arg, string values_change, string condition)
        {
        ...
        [MessageCallback]
        public void Request_BD(string query)
        {
        ...
        [MessageCallback]
        public void Deleted_BD(string table_arg, string condition_del)
        {
            database.Delete(table_arg, condition_del);
        }
        ...
        /// <returns></returns>
        [MessageCallback]
        public int Count_BD(string table)
        {
        ...
        /// <returns></returns>
        [MessageCallback]
        public string[][] Select_BD(string table_noarg, string selection)
        {
